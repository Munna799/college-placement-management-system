            ...
            <div className="my-4 max-md:p-2 md:p-6 overflow-auto">
              <div className="">
                ...
                <Accordion defaultActiveKey={['1']} flush className='flex flex-col gap-4'>
                  ...
                  <Accordion.Item eventKey="5" className='backdrop-blur-md bg-white/30 border border-white/20 rounded-lg shadow shadow-red-400'>
                    <Accordion.Header>Unassigned / Incomplete Profile</Accordion.Header>
                    <Accordion.Body>
                      <Accordion flush defaultActiveKey={['Unassigned']} className='flex flex-col gap-2'>
                        <StudentTable branchName={"Unassigned"} studentData={unassignedStudents} />
                      </Accordion>
                    </Accordion.Body>
                  </Accordion.Item>
