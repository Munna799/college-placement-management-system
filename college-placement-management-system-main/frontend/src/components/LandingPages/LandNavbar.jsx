      ...
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center py-3 px-4">
        ...
        <div className="flex max-md:gap-1 md:gap-3 items-center">
          <Button
            ...
            size={buttonSize}
            className="transition-all hover:scale-105 hover:shadow-md px-3 md:min-w-[110px] whitespace-nowrap"
          ...
          <Button
            ...
            size={buttonSize}
            className="transition-all hover:scale-105 hover:shadow-md px-3 md:min-w-[170px] whitespace-nowrap"
