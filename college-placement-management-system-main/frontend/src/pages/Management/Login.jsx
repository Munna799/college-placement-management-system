...
function LoginManagement() {
  ...
  // if login user visit redirect to correct dashboard
  useEffect(() => {
    ...
    axios.get(`${BASE_URL}/user/detail`, {
      ...
      .then((res) => {
        if (res.data.role === 'management_admin') navigate('/management/dashboard');
        else if (res.data.role === 'tpo_admin') navigate('/tpo/dashboard');
        else if (res.data.role === 'student') navigate('/student/dashboard');
        else if (res.data.role === 'superuser') navigate('/admin');
      })
      .catch(() => {
