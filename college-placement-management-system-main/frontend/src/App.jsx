...
function Layout({ header }) {
  ...
  return (
    <>
      <div className="flex min-h-screen flex-col bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.18),_transparent_30%),linear-gradient(135deg,_#f8fbff_0%,_#eef4ff_45%,_#f8fafc_100%)]">
        <Navbar isSidebarVisible={isSidebarVisible} toggleSidebar={toggleSidebar} />
        <div className="flex flex-grow">
          <Sidebar isSidebarVisible={isSidebarVisible} />
          <div className={`content flex-grow p-4 transition-all duration-300 md:p-6 ${isSidebarVisible ? 'md:ml-64' : 'ml-0'} overflow-hidden`}>
            <div className="h-full rounded-[28px] border border-slate-200/80 bg-white/80 p-4 shadow-[0_20px_60px_-20px_rgba(15,23,42,0.3)] backdrop-blur-xl md:p-6">
